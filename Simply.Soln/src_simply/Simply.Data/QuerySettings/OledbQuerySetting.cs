...
namespace Simply.Data
{
    ...
    /// </summary>
    internal class OledbQuerySetting : BaseQuerySetting
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OledbQuerySetting"/> class.
        /// </summary>
        /// <param name="connectionType">Database Connection type.</param>
        public OledbQuerySetting(DbConnectionTypes connectionType) : base(connectionType)
        {

...
namespace Simply.Data
{
    ...
    /// </summary>
    internal class VistaDbQuerySetting : BaseQuerySetting
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VistaDbQuerySetting"/> class.
        /// </summary>
        /// <param name="connectionType">Database Connection type.</param>
        public VistaDbQuerySetting(DbConnectionTypes connectionType) : base(connectionType)
        {
